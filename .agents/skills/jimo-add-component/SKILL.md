...
description: >
  ...
  a component. Always use this skill — it enforces AGENTS.md rules that are easy to
...
All rules in this skill are derived from `AGENTS.md` in the repo root — the single source of truth.
