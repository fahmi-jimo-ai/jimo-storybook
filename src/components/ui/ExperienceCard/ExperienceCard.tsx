...
import { ExperienceStatus, ExperienceStatusValue } from '../ExperienceStatus/ExperienceStatus';
import { ExperienceTags, ExperienceTagItem } from '../ExperienceTags/ExperienceTags';
import '../ExperienceStatus/ExperienceStatus.css';
import '../ExperienceTags/ExperienceTags.css';
import './ExperienceCard.css';

export type ExperienceCardLayout = 'grid' | 'line' | 'compact';

export interface ExperienceCardProps {
  title: string;
  createdAt: string;
  status?: ExperienceStatusValue;
  tags?: ExperienceTagItem[];
  targeting?: string;
  environment?: string;
  layout?: ExperienceCardLayout;
  thumbnailContent?: React.ReactNode;
  /** Apply hover appearance for snapshot stories */
  hover?: boolean;
  className?: string;
}
