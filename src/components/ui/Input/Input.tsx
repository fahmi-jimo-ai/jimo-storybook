...
export type InputStatus = 'none' | 'loading' | 'positive' | 'warning' | 'negative';
export type InputType = 'text' | 'textarea' | 'dropdown' | 'dropdown-search';

/**
 * HTML input type — governs browser validation and keyboard behaviour.
 * Use 'number' for numeric-only fields, 'email' for email, etc.
 */
export type InputHtmlType = 'text' | 'number' | 'email' | 'tel' | 'url' | 'password' | 'search';
...
export interface InputProps
  ...
  inputType?: InputType;
  /**
   * HTML input type — controls keyboard/validation behaviour.
   * Defaults to 'text'. Use 'number' for numeric fields, 'email' for email, etc.
   * Has no effect when inputType is 'textarea'.
   */
  type?: InputHtmlType;
  /** Field label */
  label?: React.ReactNode;
  /** Helper / supportive text shown below */
  supportiveText?: React.ReactNode;
  /** Icon on the left inside the input */
  leftIcon?: React.ReactNode;
  /** Icon on the right inside the input */
  rightIcon?: React.ReactNode;
  /** Unit / trailing text (e.g. "Days") */
  trailingText?: string;
  /** Additional action button slotted inside the input */
  cta?: React.ReactNode;
  /** Secondary value slot (dropdown prefix) */
