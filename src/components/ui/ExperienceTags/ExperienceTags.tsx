...
export type TagColor = 'blue' | 'orange' | 'purple';

export interface ExperienceTagItem {
  label: string;
  color?: TagColor;
}
...
const CYCLE_COLORS: TagColor[] = ['blue', 'orange', 'purple'];

export const ExperienceTags: React.FC<ExperienceTagsProps> = ({
  tags,
  maxVisible,
  className,
}) => {
