...
import type { ToastType } from '../../../src/components/ui/Toast/Toast';
...
const meta: Meta<typeof Toast> = {
  ...
  argTypes: {
    type: {
      control: 'select',
      options: ['neutral', 'positive', 'warning', 'negative'] satisfies ToastType[],
...
export const AllTypes: Story = {
  render: () => {
    const variants: { type: ToastType; title: string }[] = [
