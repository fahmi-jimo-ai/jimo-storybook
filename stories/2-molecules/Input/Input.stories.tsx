...
import type { InputSize, InputStatus, InputType, InputHtmlType } from '../../../src/components/ui/Input/Input';
...
const meta: Meta<InputStoryArgs> = {
  ...
  argTypes: {
    ...
    inputType: {
      name: 'type',
      control: 'select',
      options: ['text', 'textarea', 'dropdown', 'dropdown-search'] satisfies InputType[],
    ...
    status: {
      name: 'state',
      control: 'select',
      options: ['none', 'loading', 'positive', 'warning', 'negative'] satisfies InputStatus[],
      description: 'Status indicator — maps to `status` prop in code',
      table: { defaultValue: { summary: 'none' } },
    },
    size: {
      control: 'select',
      options: ['regular', 'small'] satisfies InputSize[],
    ...
    type: {
      name: 'htmlType',
      control: 'select',
      options: ['text', 'number', 'email', 'tel', 'url', 'password', 'search'] satisfies InputHtmlType[],
