...
import type { InfoboxType } from '../../../src/components/ui/Infobox/Infobox';
...
const meta: Meta<typeof Infobox> = {
  ...
  argTypes: {
    type: {
      control: 'select',
      options: ['neutral', 'positive', 'warning', 'danger', 'brand'] satisfies InfoboxType[],
...
export const SemanticTypes: Story = {
  render: () => {
    const variants: { type: InfoboxType; title: string; body: string }[] = [
