...
/**
 * Complete list of all 993 iconsax-react v0.0.8 icon names.
 * Shared across stories that need full icon selection (Button, etc.).
 */
...
/**
 * Resolves an icon name to a React component from iconsax-react.
