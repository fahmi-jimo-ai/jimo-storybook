...
const STAGE_ITEMS: DropdownFilterItem[] = [
...
const ADOPTION_ITEMS: DropdownFilterItem[] = [
  { value: 'low', label: 'Low' },
  { value: 'medium', label: 'Medium' },
  { value: 'high', label: 'High' },
];

const STATUS_ITEMS: DropdownFilterItem[] = [
...
const SEGMENT_ITEMS: DropdownFilterItem[] = [
  {
    value: 'enterprise',
    label: 'Enterprise',
